 ...
 */
 ...
 ----------   ---   ---------------------------------------------------------
 2019-06-13   as    Update copyright notice year.
 2019-04-23   as    Deprecate support for few QAPIs.
 2018-01-24   leo   (Tech Comm) Edited Doxygen comments w.r.t mmu changes.
 2018-01-19   as    Cleanup comments.
 2017-12-11   as    updated Doxygen comments w.r.t mmu changes.
...
============================================================================*/
/**
 *  Attempts to read Count bytes of data from the file associated with
...
============================================================================*/
/**
 *  Attempts to write 'Count' bytes of data to the file associated with
 *         the specified file descriptor.
 *
 ...
 * @return Returns QAPI_OK on success and -ve error code is returned on failure.
 *
 * @note1hang If this API is called from user space with MMU enabled then,
 *            the parameters should be userspace addresses or else
 *            invalid param error will be returned.
 */
...
==============================================================================*/
/**
 *  Reads the next entry in the directory using the opened directory
 *  iterator.
 *
...
============================================================================*/
/**
 *  Returns the last error that occured in current task's context.
 *
