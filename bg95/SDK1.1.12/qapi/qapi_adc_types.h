 ...
 *
 * Type definitions for ADC QAPIs.
 */
...
#if !defined(_QUECTEL_PROJECT_BG77)  
...
#define ADC_INPUT_ADC0            "GPIO_02" 	//QuectelModifyFlag

#if defined(_QUECTEL_PROJECT_BG77)  
#define ADC_INPUT_ADC1            "GPIO_04" 	//QuectelModifyFlag
#endif
...
/** ADC read results.
*/
// add by lane@20171128	//QuectelModifyFlag
typedef enum
{
   ADC_RESULT_INVALID,
   ADC_RESULT_VALID,
...
typedef struct
{
   AdcResultStatusType eStatus;//unsigned int  eStatus;  /**< Status of the conversion. */ //modified by lane@20171128  //QuectelModifyFlag
