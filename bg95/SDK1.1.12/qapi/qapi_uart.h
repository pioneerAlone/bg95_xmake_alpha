...
$Header: //components/rel/core.tx/5.0/buses/api/uart/qapi_uart.h#4 $
...
typedef int  (*uart_tx_dispatcher_cb)(void *pfnUser_cb, int cb_param1, int cb_param2);
typedef int  (*uart_rx_dispatcher_cb)(void *pfnUser_cb, int cb_param1, int cb_param2);
...
*
*  @return
*  - QAPI_OK     -- UART IOCTL configuration was successfull.
