...
2017-05-01   leo   (Tech Comm) Edited/added Doxygen comments and markup.
...
#define  TXM_QAPI_ADC_AMP_THRESHOLD_CB      CUSTOM_CB_QAPI_ADC_BASE
#define  TXM_QAPI_ADC_SET_TOLERENCE_CB      CUSTOM_CB_QAPI_ADC_BASE + 1
...
static int qapi_custom_cb_ADC_dispatcher(UINT cb_id, void *app_cb, 
...
#define qapi_ADC_Set_Amp_Threshold(Handle, Params_Ptr, Threshold_Type, \
    ...
    (ULONG) Threshold_Desired_Ptr, (ULONG) Threshold_Set_Ptr, (ULONG) qapi_custom_cb_ADC_dispatcher,\
    (ULONG) 0, (ULONG) 0, (ULONG) 0, (ULONG) 0, (ULONG) 0, (ULONG) 0))
...
#define qapi_ADC_TM_Set_Tolerance(Handle, Params_Type_Ptr, \
    ...
    (ULONG) Higher_Tolerance_Ptr, (ULONG) qapi_custom_cb_ADC_dispatcher, (ULONG) 0, (ULONG) 0, (ULONG) 0,\
...
============================================================================*/
/**
*  @deprecated API is deprecated since TM peripheral is not present in PMIC.
*
