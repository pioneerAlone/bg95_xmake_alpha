 ...
 */
 ...
 /**< @deprecated Use enum QAPI_DEVICE_INFO_TIME_ZONE_E instead. Device time zone. Response type:QAPI_DEVICE_INFO_TYPE_INTEGER_E. Operation: Query. */
 ...
 /**< @deprecated Use enum QAPI_DEVICE_INFO_ICCID_E instead. Device ICCID. Response type:QAPI_DEVICE_INFO_TYPE_BUFFER_E. Operation: Query. */
...
/**< Location Area Code. Response type:QAPI_DEVICE_INFO_TYPE_INTEGER_E. Operation: Query. */
 ...
 /**< Device App priority. Response type: QAPI_DEVICE_INFO_TYPE_INTEGER_E. Operation: Set. */

 QAPI_DEVICE_INFO_GET_APP_PRIORITY_E,
 /**< Device App priority. Response type: QAPI_DEVICE_INFO_TYPE_INTEGER_E. Operation: Query. */

 QAPI_DEVICE_INFO_GET_LOADED_TECH_E,
 /**< Device currently loaded technology. Response type: QAPI_DEVICE_INFO_TYPE_INTEGER_E. Operation: Query. */
