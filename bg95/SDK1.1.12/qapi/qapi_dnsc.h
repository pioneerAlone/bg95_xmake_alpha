...
/**
 *  Data structure returned from qapi_gethostbyname() or qapi_gethostbyname2().
...
#define qapi_Net_DNSc_Host_By_Name2(a,b,c)          ((UINT) (_txm_module_system_call12)(TXM_QAPI_NET_DNSC_GETHOSTBYNAME2         , (ULONG) a, (ULONG) b, (ULONG) c, (ULONG) 0, (ULONG) 0, (ULONG) 0, (ULONG) 0, (ULONG) 0, (ULONG) 0, (ULONG) 0, (ULONG) 0, (ULONG) 0))
