...
--------   ---     ------------------------------------------------------------
06/11/19   PG      Updated Copyright format as per guidelines
...
// Handler Prototype
qapi_Status_t qapi_PM_Rtc_handler(
	UINT id,
	UINT a,
	UINT b,
	UINT c,
...
@param[in] cmd  Indicates whether to set or get the current time in the RTC. \n
        ...
        - passing QAPI_PM_RTC_SET_CMD_E is not allowed but API is not deprecated
