...
#define TXM_QAPI_LOCATION_GET_GNSS_ENERGY_CONSUMED     TXM_QAPI_LOCATION_BASE + 24
...
@{ */
  ...
  * Location 1.2.0  &  Added last 4 enums. 
  * Location 1.5.0  &  Added last 1 enum.
  * @tblendline } 
  *
...
typedef enum {
    ...
    QAPI_LOCATION_ERROR_TIMEOUT,                  /**< Timeout when asking single shot. Added in Location 1.2.0. */
    QAPI_LOCATION_ERROR_LOAD_FAILURE,             /**< GNSS engine could not get loaded. Added in Location 1.2.0. */
    QAPI_LOCATION_ERROR_LOCATION_DISABLED,        /**< Location module license is disabled. Added in Location 1.2.0. */
    QAPI_LOCATION_ERROR_BEST_AVAIL_POS_INVALID,   /**< Best available position is invalid. Added in Location 1.2.0. */
    QAPI_LOCATION_ERROR_TIMEOUT_ACC_CHECK_FAILED, /**< Timeout when asking single shot. Added in Location 1.5.0. */
 ...
 * Requests energy consumed parameters.
  ...
  @return
  \li QAPI_LOCATION_ERROR_SUCCESS -- The operation was successful. 
  \li QAPI_LOCATION_ERROR_ID_UNKNOWN -- Invalid client ID provided. 
  \li QAPI_LOCATION_ERROR_NOT_INITIALIZED -- No user space buffer is set. 
  \li QAPI_LOCATION_ERROR_CALLBACK_MISSING -- Metadata callback is not set. 
  \li QAPI_LOCATION_ERROR_GENERAL_FAILURE -- Internal failure while processing
                                         the request.
*/
