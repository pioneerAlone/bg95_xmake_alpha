...
#define DATA_CUSTOM_CB_COAP_CREATE_SESSION   CUSTOM_CB_QAPI_DATA_SERVICES_BASE+13
#define DATA_CUSTOM_CB_COAP_TRANSACTION      CUSTOM_CB_QAPI_DATA_SERVICES_BASE+14
#define DATA_CUSTOM_CB_COAP_REGISTER_EVENT   CUSTOM_CB_QAPI_DATA_SERVICES_BASE+15
...
/**
 *  Utility API to map a user space address to the handle. Only 
...
/**
 *  Utility API to retrieve the user space address corresponding to 
