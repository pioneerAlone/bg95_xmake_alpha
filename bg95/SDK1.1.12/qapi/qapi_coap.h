...
#define  TXM_QAPI_COAP_SET_HEADER_EXT                 TXM_QAPI_COAP_BASE + 14
#define  TXM_QAPI_COAP_GET_HEADER_EXT                 TXM_QAPI_COAP_BASE + 15
#define  TXM_QAPI_COAP_REGISTER_EVENT                 TXM_QAPI_COAP_BASE2 + 1
...
typedef enum {
   ...
   QAPI_COAP_EXTENDED_CONFIG_DTLS_HANDLE_ALERT_WITH_EPOCH_0,  /**< Extended configuration option to accept or discard an alert with epoch=0
                                                                   after handshake process completed Per RFC spec, SSL should discard packets
                                                                   with epoch=0 after handshake, but in some special network environment, 
                                                                   DTLS session may be lost and server cannot fill correct epoch and sequence number,
                                                                   then server sends alert with epoch=0 to notify session is down and client need to 
                                                                   do re-handshake. 
                                                                   For this option "val" field of qapi_Coap_Set_Extended_Config_Option() data type is
                                                                   boolean, and range is [0, 1].
                                                                   1: SSL layer will accept the alert packet with epoch=0, as normal alert.
                                                                   0: SSL layer will discard the alert packet with epoch=0. */
                                                                  ...
                                                                  UINT cb_param8)
{
  ...
  void (*pfn_app_cb3) (qapi_Coap_Session_Hdl_t , qapi_Coap_Event_Callback_t );
  ...
  if (cb_id == DATA_CUSTOM_CB_COAP_REGISTER_EVENT)
  {
    pfn_app_cb3 = (void (*)(qapi_Coap_Session_Hdl_t ,qapi_Coap_Event_Callback_t))app_cb;
    (pfn_app_cb3)((qapi_Coap_Session_Hdl_t)cb_param1, (qapi_Coap_Event_Callback_t) cb_param2);
  }
}
    ...
    /*
    * Macro that Releases Byte Pool Pointer for CoAP Application and closes session
    * Parameter 'a' : Handle 
    * On success, QAPI_OK is returned. On error, QAPI_ERROR is returned.
    * (This Macro is only used in DAM Space)
    */
 
    #define qapi_Coap_Destroy_Session(a)                     coap_destroy_indirection(a)
    ...
    #define qapi_Coap_Set_Header_Ext(a,b,c,d,e)              ((qapi_Status_t) (_txm_module_system_call12)(TXM_QAPI_COAP_SET_HEADER_EXT, (ULONG) a, (ULONG) b, (ULONG) c, (ULONG) d, (ULONG) e, (ULONG) 0, (ULONG) 0, (ULONG) 0, (ULONG) 0, (ULONG) 0, (ULONG) 0, (ULONG) 0))
    #define qapi_Coap_Get_Header_Ext(a,b,c,d,e)              ((qapi_Status_t) (_txm_module_system_call12)(TXM_QAPI_COAP_GET_HEADER_EXT, (ULONG) a, (ULONG) b, (ULONG) c, (ULONG) d, (ULONG) e, (ULONG) 0, (ULONG) 0, (ULONG) 0, (ULONG) 0, (ULONG) 0, (ULONG) 0, (ULONG) 0))
    #define qapi_Coap_Register_Event(a,b) 			 ((qapi_Status_t) (_txm_module_system_call12)(TXM_QAPI_COAP_REGISTER_EVENT, (ULONG) a, (ULONG) b, (ULONG) qapi_Coap_Client_Session_uspace_dispatcher, (ULONG) 0, (ULONG) 0, (ULONG) 0, (ULONG) 0, (ULONG) 0, (ULONG) 0, (ULONG) 0, (ULONG) 0, (ULONG) 0))
...
static __inline int coap_destroy_indirection(qapi_Coap_Session_Hdl_t hndl)
{
  int ret = QAPI_ERROR;
  qapi_cb_params_uspace_ptr_t* uspace_memory_coap = NULL;
  int i=0;

  if (qapi_data_map_handle_to_u_addr(hndl, QAPI_APP_COAP , (void**)&uspace_memory_coap) == QAPI_OK)
  {
    if (uspace_memory_coap != NULL)
    {
       for (i=0;i<uspace_memory_coap->cb_count; i++)
       {
         if (uspace_memory_coap->cb_param[i] != NULL)
         { 
           tx_byte_release(uspace_memory_coap->cb_param[i]);
           uspace_memory_coap->cb_param[i]=NULL;
           uspace_memory_coap->cb_count--;
         }
       }
     }
    }
    ...
    {
      tx_byte_release(uspace_memory_coap);
      uspace_memory_coap=NULL;
    }

  ret = ((qapi_Status_t)  (_txm_module_system_call12)(TXM_QAPI_COAP_DESTROY_SESSION , (ULONG) hndl, (ULONG) 0, (ULONG) 0, (ULONG) 0, (ULONG) 0, (ULONG) 0, (ULONG) 0, (ULONG) 0, (ULONG) 0, (ULONG) 0, (ULONG) 0, (ULONG) 0));
...
/**
 * @versiontable{2.0,2.45,
 * Data\_Services 1.9.0  &  Introduced. @tblendline
 * }
 *      This function is used to Register coap Event Callback
 *
 * @param  hdl[in]                CoAP Session Handle returned by Create Session .
 * @param  event_cb_ptr[in]       pointer to event callback
