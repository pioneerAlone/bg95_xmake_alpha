...
$Header: //components/rel/core.tx/5.0/buses/api/i2c/qapi_i2c_master.h#4 $

when       who     what, where, why
--------   ---     ----------------------------------------------------------------- 
02/04/2019   ss     Changes the Qapi Header File for Twizy(MDM9205).
09/11/2017   vg     Added I2C DAM changes
...
#define TXM_QAPI_I2C_NOTIFY_CALLBACK       TXM_QAPI_BUSES_I2C_CB_BASE 
...
#define QAPI_I2CM_ERROR_PLATFORM_DETACH_FAILURE     __QAPI_ERROR(QAPI_MOD_BSP_I2C_MASTER, 35)   /* I2C DAL Detach failed. */
...
#define QAPI_I2CM_ERR_INVALID_BUFFER_POINTER       __QAPI_ERROR(QAPI_MOD_BSP_I2C_MASTER, 41)   /* I2C DAL Invalid Buffer arg */

#define QAPI_I2CM_ERROR_POWER_ON_FAILURE           __QAPI_ERROR(QAPI_MOD_BSP_I2C_MASTER, 42)
#define QAPI_I2CM_ERROR_POWER_OFF_FAILURE          __QAPI_ERROR(QAPI_MOD_BSP_I2C_MASTER, 43) 
...
static int i2c_module_cb_manager(UINT cb_id, void *app_cb, 
