...
/*==================================================================================
 ...
 $Header: //components/rel/core.tx/5.0/api/systemdrivers/qapi_gpioint.h#3 $

 when       who     what, where, why
 --------   ---     -----------------------------------------------------------------
 07/18/19   shm     Made QAPI handler public for FR57064.
 04/25/18   leo     (TechComm) Edited/added Doxygen comments and markup.
 ...
 * @file qapi_gpioint.h
 *
 *  QAPI GPIO interrupt controller module.
 *
...
static void qapi_custom_cb_gpioint_dispatcher(UINT cb_id, void *app_cb, 
                                       UINT cb_param1);
                                       ...
                                       UINT cb_param1)
{
  ...
  if(cb_id - TXM_QAPI_GPIOINT_REGISTER_INTERRUPT_CB <= 5) // custom cb-type1   /Quectel modified,increase the number of gpio interrupts up to five/
  {
...
qapi_Status_t qapi_gpioint_handler
(
  UINT id,
  UINT a,
  UINT b,
